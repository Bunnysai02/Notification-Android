...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button showNotificationBtn = findViewById(R.id.bt_show);
        showNotificationBtn.setOnClickListener((view) -> {
            showNotification();
        });
    }
    ...
    private void showNotification() {
        ...
        Intent intent1 = new Intent(MainActivity.this, YesActivity.class);
        ...
        Intent intent2 = new Intent(MainActivity.this, NoActivity.class);
